...
description: "How to obtain, use, and protect Plex Media Server API tokens"
---
...
<Tip>
The token shown is tied to the signed-in account. If you share the server with others, each account has its own token.
</Tip>
...
- Read the [SDKs](/SDKs) page for language-specific client libraries.
